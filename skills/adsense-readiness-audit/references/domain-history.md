...
| 上线与抓取 | 域名/DNS 故障、404/5xx、登录墙、robots、Cloudflare/CDN/WAF Challenge、`520`–`526`、Bot/Access/地域/IP 阻断、无效 TLS、缓存旧站、Workers/重定向循环 | 多数可抽查；Cloudflare 站点按 [cloudflare-cdn.md](cloudflare-cdn.md) 补查后台事件 |
